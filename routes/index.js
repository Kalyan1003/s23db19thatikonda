...
res.render('index', { title: 'Library App', user : req.user });
});
router.get('/register', function(req, res) {
res.render('register', { title: 'Library App Registration'});
});
...
router.get('/login', function(req, res) {
  res.render('login', { title: 'Library App Login', user : req.user });
  });
